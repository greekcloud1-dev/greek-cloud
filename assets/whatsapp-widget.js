...
(function () {
  ...
  // The real WhatsApp glyph (Simple Icons' path), not a hand-drawn
  // approximation — recognizable at a glance the way the site's other
  // bespoke line icons aren't meant to be.
  a.innerHTML =
    ...
    '0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 ' +
    '4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-' +
    '4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 ' +
    '2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 ' +
